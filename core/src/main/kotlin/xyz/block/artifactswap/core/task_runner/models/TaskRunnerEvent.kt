...
data class TaskRunnerExecutionEvent(
  @Json(name = "result") val result: TaskRunnerResult = TaskRunnerResult.NONE,
  @Json(name = "count_tasks_to_run") val countTasksToRun: Int = -1,
  @Json(name = "count_tasks_succeeded") val countTasksSucceeded: Int = -1,
  @Json(name = "count_tasks_failed") val countTasksFailed: Int = -1,
  @Json(name = "task_execution_duration_ms") val taskExecutionDurationMs: Long = -1,
  @Json(name = "total_duration_ms") val totalDurationMs: Long = -1,
  @Json(name = "git_branch") val gitBranch: String = "",
  @Json(name = "git_sha") val gitSha: String = "",
