...
object ArtifactSwapConfigHolder {
  /**
   * The current configuration instance. Defaults to Square/Block values. Can be reassigned at
   * runtime to customize behavior.
   */
   ...
   *
   * This means global settings in your home directory will override project-specific settings,
  ...
  private fun createFromGradleProperties(): ArtifactSwapConfig {
    ...
    if (localGradlePropertiesFile.exists()) {
      logger.info {
        "Loading ArtifactSwapConfig from local gradle properties: $localGradlePropertiesFile"
      }
    ...
    if (globalGradlePropertiesFile.exists()) {
      logger.info {
        "Loading ArtifactSwapConfig from global gradle properties: $globalGradlePropertiesFile"
      }
    ...
    return ArtifactSwapConfig(
      ...
      eventstreamBaseUrl =
        getPropertyWithLogging("artifactswap.eventstreamBaseUrl", defaults.eventstreamBaseUrl),
      artifactoryPublisherTokenFileName =
        getPropertyWithLogging(
          "artifactswap.artifactoryPublisherTokenFileName",
          defaults.artifactoryPublisherTokenFileName,
        ),
      eventstreamGzipHeaderName =
        getOptionalPropertyWithLogging("artifactswap.eventstreamGzipHeaderName"),
      ...
      useLocalProtosProperty =
        getPropertyWithLogging(
          "artifactswap.useLocalProtosProperty",
          defaults.useLocalProtosProperty,
        ),
      buildToolkitPluginProperty =
        getPropertyWithLogging(
          "artifactswap.buildToolkitPluginProperty",
          defaults.buildToolkitPluginProperty,
        ),
      forceModulesOverrideProperty =
        getPropertyWithLogging(
          "artifactswap.forceModulesOverrideProperty",
          defaults.forceModulesOverrideProperty,
        ),
      artifactVersionExtraProperty =
        getPropertyWithLogging(
          "artifactswap.artifactVersionExtraProperty",
          defaults.artifactVersionExtraProperty,
        ),
      settingsOverrideFileName =
        getPropertyWithLogging(
          "artifactswap.settingsOverrideFileName",
          defaults.settingsOverrideFileName,
        ),
      artifactHashCachePath =
        getPropertyWithLogging(
          "artifactswap.artifactHashCachePath",
          defaults.artifactHashCachePath,
        ),
      cliToolDisplayName =
        getPropertyWithLogging("artifactswap.cliToolDisplayName", defaults.cliToolDisplayName),
      artifactoryBaseUrl =
        getPropertyWithLogging("artifactswap.artifactoryBaseUrl", defaults.artifactoryBaseUrl),
    )
  }
}
