...
public class LogEventStreamV2Request(
  ...
  @field:WireField(tag = 2, adapter = "com.squareup.wire.ProtoAdapter#BOOL", schemaIndex = 1)
  public val sync: Boolean? = null,
  unknownFields: ByteString = ByteString.EMPTY,
) : Message<LogEventStreamV2Request, Nothing>(ADAPTER, unknownFields) {
  @field:WireField(
    tag = 1,
    adapter = "xyz.block.artifactswap.core.eventstream.EventstreamV2Event#ADAPTER",
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<LogEventStreamV2Request> =
      object :
        ProtoAdapter<LogEventStreamV2Request>(
        ...
        override fun redact(`value`: LogEventStreamV2Request): LogEventStreamV2Request =
          value.copy(
