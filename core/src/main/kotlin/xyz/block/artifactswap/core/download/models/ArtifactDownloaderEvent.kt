...
data class ArtifactDownloaderEvent(
  @Json(name = "result") val result: ArtifactDownloaderResult = ArtifactDownloaderResult.NOT_SET,
  @Json(name = "count_artifacts_to_download") val countArtifactsToDownload: Int = -1,
  ...
  @Json(name = "count_artifacts_failed_to_install") val countFailedInstalledArtifacts: Long = -1L,
  @Json(name = "total_duration_ms") val totalDurationMs: Long = -1L,
  @Json(name = "total_download_size_mb") val totalDownloadSizeMb: Long = -1L,
  @Json(name = "get_artifacts_to_download_duration_ms")
  val getArtifactsToDownloadDurationMs: Long = -1L,
  @Json(name = "download_artifacts_p50_duration_ms") val p50DownloadTimeMs: Long = -1L,
  @Json(name = "download_artifacts_p90_duration_ms") val p90DownloadTimeMs: Long = -1L,
  @Json(name = "download_artifacts_p99_duration_ms") val p99DownloadTimeMs: Long = -1L,
  @Json(name = "download_artifacts_max_duration_ms") val maxDownloadTimeMs: Long = -1L,
  @Json(name = "install_artifacts_p50_duration_ms") val p50InstallTimeMs: Long = -1L,
  @Json(name = "install_artifacts_p90_duration_ms") val p90InstallTimeMs: Long = -1L,
  @Json(name = "install_artifacts_p99_duration_ms") val p99InstallTimeMs: Long = -1L,
  @Json(name = "install_artifacts_max_duration_ms") val maxInstallTimeMs: Long = -1L,
  ...
  @Json(name = "base_git_branch") val gitBranch: String = "",
  @Json(name = "base_git_sha") val gitSha: String = "",
  @Json(name = "ci_env") val ciEnv: String = "",
  @Json(name = "base_build_id") val buildId: String = "",
  @Json(name = "base_build_step_id") val buildStepId: String = "",
