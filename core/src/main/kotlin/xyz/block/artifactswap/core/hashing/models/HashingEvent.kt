...
data class HashingExecutionEvent(
  ...
  @Json(name = "hash_projects_duration_ms") val hashProjectsDurationMs: Long = -1,
  @Json(name = "count_projects_hashed") val countProjectsHashed: Int = -1,
  @Json(ignore = true) val includedProjects: Set<String> = emptySet(),
  @Json(name = "count_projects_included") val countProjectsIncluded: Int = -1,
  @Json(name = "count_files_hashed") val countFilesHashed: Int = -1,
