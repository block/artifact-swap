...
data class ArtifactCheckerExecutionEvent(
  @Json(name = "result") val result: ArtifactCheckerResult = ArtifactCheckerResult.UNKNOWN,
  @Json(name = "count_projects_to_check") val countProjectsToCheck: Int = -1,
  @Json(name = "count_artifacts_found") val countArtifactsFound: Int = -1,
  @Json(name = "total_duration_ms") val totalDurationMs: Long = -1,
  @Json(name = "determine_projects_duration_ms") val determineProjectsDurationMs: Long = -1,
  @Json(name = "check_artifactory_duration_ms") val checkArtifactoryDurationMs: Long = -1,
  @Json(name = "ci_git_branch") val gitBranch: String = "",
  @Json(name = "ci_git_sha") val gitSha: String = "",
