...
data class TaskFinderExecutionEvent(
  @Json(name = "result") val result: TaskFinderResult = TaskFinderResult.NONE,
  @Json(name = "task_name") val taskName: String = "",
  @Json(name = "count_tasks_with_name") val countTasksWithName: Int = -1,
  @Json(name = "count_tasks_in_last_output_file") val countTasksInLastOutputFile: Int = -1,
  @Json(name = "gradle_project_connection_duration_ms")
  val gradleProjectConnectionDurationMs: Long = -1,
  @Json(name = "gradle_task_finding_duration_ms") val gradleTaskFindingDurationMs: Long = -1,
