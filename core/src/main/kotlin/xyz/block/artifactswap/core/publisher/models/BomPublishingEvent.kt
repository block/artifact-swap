...
data class BomPublishingEvent(
  @Json(name = "result") val result: BomPublishingResult? = null,
  @Json(name = "total_duration_ms") val totalDurationMs: Long? = null,
  @Json(name = "read_hashed_projects_duration_ms") val readHashedProjectsDurationMs: Long? = null,
  @Json(name = "request_project_data_artifactory_duration_ms")
  val requestProjectDataArtifactoryDurationMs: Long? = null,
  @Json(name = "publish_updated_bom_and_metadata_duration_ms")
  val publishUpdatedBomAndMetadataDurationMs: Long? = null,
  @Json(name = "count_projects_hashed") val countProjectsHashed: Long? = null,
  @Json(name = "count_projects_in_artifactory") val countProjectsInArtifactory: Long? = null,
  @Json(name = "count_projects_included_in_bom") val countProjectsIncludedInBom: Long? = null,
  @Json(name = "base_git_branch") val gitBranch: String,
  @Json(name = "base_git_sha") val gitSha: String,
  @Json(name = "ci_env") val kochikuEnv: String,
  @Json(name = "ci_build_id") val buildId: String,
