...
data class ArtifactRemoverResult(
  ...
  @Json(ignore = true) val startRepoStats: RepositoryStats? = null,
  @Json(ignore = true) val endRepoStats: RepositoryStats? = null,
  @Json(ignore = true) val deleteOldArtifactsResult: DeleteOldArtifactsResult? = null,
  @Json(ignore = true) val deleteOldArtifactsDuration: Duration? = null,
  @Json(ignore = true) val deleteOldBomsResult: DeleteOldBomsResult? = null,
  @Json(ignore = true) val deleteOldBomsDuration: Duration? = null,
  @Json(ignore = true) val totalDuration: Duration? = null,
) {
  fun toArtifactRemoverEvent(): ArtifactRemoverEvent {
    return ArtifactRemoverEvent(
      ...
      startInstalledArtifactsMeasurementDurationMs =
        startRepoStats?.installedArtifactsMeasurementDuration?.inWholeMillisecondsIfFinite ?: -1,
      startInstalledBomsMeasurementDurationMs =
        startRepoStats?.installedBomsMeasurementDuration?.inWholeMillisecondsIfFinite ?: -1,
      startMeasureRepoDurationMs =
        startRepoStats?.measurementDuration?.inWholeMillisecondsIfFinite ?: -1,
      endInstalledArtifactsMeasurementDurationMs =
        endRepoStats?.installedArtifactsMeasurementDuration?.inWholeMillisecondsIfFinite ?: -1,
      endInstalledBomsMeasurementDurationMs =
        endRepoStats?.installedBomsMeasurementDuration?.inWholeMillisecondsIfFinite ?: -1,
      endMeasureRepoDurationMs =
        endRepoStats?.measurementDuration?.inWholeMillisecondsIfFinite ?: -1,
      ...
      deleteOldArtifactsResultAttemptedDeletionArtifacts =
        deleteOldArtifactsResult?.attemptedToDelete?.size?.toLong() ?: -1,
      deleteOldArtifactsResultDeletedArtifacts =
        deleteOldArtifactsResult?.successfulDeletion?.size?.toLong() ?: -1,
      deleteOldArtifactsResultFailedToDeleteArtifacts =
        deleteOldArtifactsResult?.failedDeletion?.size?.toLong() ?: -1,
      deleteOldArtifactsDurationMs = deleteOldArtifactsDuration?.inWholeMillisecondsIfFinite ?: -1,
      deleteOldBomsResultAttemptedDeletionBoms =
        deleteOldBomsResult?.attemptedDeletionBoms?.size?.toLong() ?: -1,
      deleteOldBomsResultDeletedBoms =
        deleteOldBomsResult?.successfulDeletionBoms?.size?.toLong() ?: -1,
      deleteOldBomsResultFailedToDeleteBoms =
        deleteOldBomsResult?.failedDeletionBoms?.size?.toLong() ?: -1,
...
data class ArtifactRemoverEvent(
  ...
  @Json(name = "repo_stats_start_overall_repo_size_bytes") val startOverallRepoSizeBytes: Long = -1,
  ...
  @Json(name = "repo_stats_end_measure_repo_duration_ms") val endMeasureRepoDurationMs: Long = -1,
  @Json(name = "repo_stats_end_overall_repo_size_bytes") val endOverallRepoSizeBytes: Long = -1,
  ...
  @Json(name = "repo_stats_end_count_installed_projects") val endCountInstalledProjects: Long = -1,
  @Json(name = "repo_stats_end_count_installed_artifacts")
  val endCountInstalledArtifacts: Long = -1,
  @Json(name = "repo_stats_end_count_boms_insalled") val endCountInstalledBoms: Long = -1,
  ...
  @Json(name = "delete_old_artifacts_duration_ms") val deleteOldArtifactsDurationMs: Long = -1,
  @Json(name = "count_boms_attempted_delete")
  val deleteOldBomsResultAttemptedDeletionBoms: Long = -1,
  @Json(name = "count_boms_successfully_deleted") val deleteOldBomsResultDeletedBoms: Long = -1,
  @Json(name = "count_boms_failed_to_delete") val deleteOldBomsResultFailedToDeleteBoms: Long = -1,
