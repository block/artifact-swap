...
interface GradleProjectsProvider {
  ...
  /**
   * Determines the participating Gradle projects that are relevant for hashing and returns a list
   * of data classes containing the relevant information from those gradle projects to compute the
   * hashes of the projects.
   */
