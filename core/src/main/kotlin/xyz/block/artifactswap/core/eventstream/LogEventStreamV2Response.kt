...
public class LogEventStreamV2Response(
  ...
  @field:WireField(tag = 1, adapter = "com.squareup.wire.ProtoAdapter#INT32", schemaIndex = 0)
  public val success_count: Int? = null,
  /** total number of messages that failed to be published */
  @field:WireField(tag = 2, adapter = "com.squareup.wire.ProtoAdapter#INT32", schemaIndex = 1)
   ...
   */
  @field:WireField(tag = 3, adapter = "com.squareup.wire.ProtoAdapter#INT32", schemaIndex = 2)
  ...
  public fun copy(
    ...
    LogEventStreamV2Response(success_count, failure_count, invalid_count, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<LogEventStreamV2Response> =
      object :
        ProtoAdapter<LogEventStreamV2Response>(
        ...
        override fun redact(`value`: LogEventStreamV2Response): LogEventStreamV2Response =
