 ...
 *
 * plugins { id 'xyz.block.artifactswap.settings.old' }
 */
@Suppress("unused")
class ArtifactSwapOldSettingsPlugin : Plugin<Settings> {
  ...
  private fun Settings.maybeApplyArtifactSync() {
    ...
    if (isIdeSync && useArtifactSync && artifactSyncOverrideFile.exists()) {
      ...
      gradle.settingsEvaluated {
        ...
        val bomVersion =
          extensions.extraProperties.get("sandbagVersion") as? String
            ?: error("Artifact Sync enabled but sandbagVersion not found in extra properties.")
  ...
  private companion object {
    val logger: Logger = Logging.getLogger(ArtifactSwapOldSettingsPlugin::class.java)
